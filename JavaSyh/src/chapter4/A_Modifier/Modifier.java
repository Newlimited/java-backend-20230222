...
// 제어자 
// 클래서, 변수 혹은 메서드의 선언ㅂ무에서 사용되는 부가적 의미를 추가해주는 키워드
// 접근 제어자 : public , protect, default, private
// 기타 제어자 : static, abstract, final

// Static -> 클래스 변수로 만들어 주는것.
// abstract -> 추상, 반드시 구현해야됨
// final -> 오버라이딩 불가능하게 만듬
...
// 클래스 선언문에 abstract 가 포함되어 있으면 해당 클래스는 구현되지 않은 메서드를
// 포함하고 있음을 의미
abstract class Example3 {
	// 메서드 선언문에 abstract가 포함되어 있으면
	// 해당 메서드는 구현되지 않았음을 의미
